...
class App extends Component {
  ...
  login = async (e) => {
    ...
    console.log(data);
    const response = await axios.post('https://neighborhood-toolshed.herokuapp.com/auth/login', data);
...
addTool = async (e) => {
    ...
    console.log(data);
    const response = await axios.post('https://neighborhood-toolshed.herokuapp.com/user/addtool',  data);
