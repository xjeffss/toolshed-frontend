...
getTools = async () => {
    ...
    const data = {
      ...
      console.log(data)
    const userResponse = await axios.post('https://neighborhood-toolshed.herokuapp.com/user/gettools', data);
    const hoodResponse = await axios.post('https://neighborhood-toolshed.herokuapp.com/user/gethood', data);
...
deleteTool = async (e, tool) => {
    ...
    console.log(data);
    const response = await axios.post( 'https://neighborhood-toolshed.herokuapp.com/user/deletetool', data);
  ...
  leaveHood = async (e, neighborhood) => {
    ...
    console.log(data);
    const response = await axios.post('https://neighborhood-toolshed.herokuapp.com/neighborhood/leavehood', data);
...
joinHood = async (e) => {
    ...
    console.log(data);
    const response = await axios.post( 'https://neighborhood-toolshed.herokuapp.com/neighborhood/joinhood', data);
...
joinHoodOnChange = (e) => {
  ...
  addHood = async (e) => {
      ...
      console.log(data);
      const response = await axios.post( 'https://neighborhood-toolshed.herokuapp.com/neighborhood/addhood', data);
